...
document.getElementById("loveIn").onclick = function() {
  ...
  function kalimatakhir(){
  	new TypeIt("#kalimat", {
      strings: ["" + katakata], startDelay: 50, speed: 94, cursor: true,
  ...
  strings: ["" + pesanAkhir2], startDelay: 100, speed: 95, cursor: true, deleteSpeed: 20, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
